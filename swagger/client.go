...
// APIClient manages communication with the Infiot API API vv9
...
type APIClient struct {
	...
	DevicePoliciesApi *DevicePoliciesApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DevicePoliciesApi = (*DevicePoliciesApiService)(&c.common)
